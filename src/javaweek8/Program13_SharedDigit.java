...
public class Program13_SharedDigit {
    ...
    public static boolean hasSharedDigit(int one, int two) {        //static method
        ...
        if ((one < 10 || one > 99) || (two < 10 || two > 99)) {     //if else loop
            return false;
        } else if (one == two) {
            return true;
    ...
    public static void main(String[] args) {
        System.out.println(hasSharedDigit(12, 23)); //static method calling
        System.out.println(hasSharedDigit(9, 99));  //static method calling
